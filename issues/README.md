...
| [`005`](file:///home/uwe/git/prime-agent/issues/005-fork-github-workflows-adaptation.md) | **GitHub Workflows Adaptation** | **Open** | Audit of `.github/workflows/`. Proposes GitHub Releases fallback for `build-binaries.yml` when R2 secrets are absent, and disabling `contribution-gate.yml`. |
